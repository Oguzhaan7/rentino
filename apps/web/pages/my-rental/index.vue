    ...
    <div class="grid gap-4 md:grid-cols-2 lg:grid-cols-4 mb-6">
      <Card>
        ...
        <CardContent>
          ...
          <p class="text-xs text-muted-foreground">
            Sonraki ödeme: {{ formatDate(rentalInfo.nextPaymentDate) }}
          </p>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent>
          <div class="text-2xl font-bold">
            <Badge
              :variant="getContractStatusVariant(rentalInfo.contractStatus)"
            >
              {{ getContractStatusLabel(rentalInfo.contractStatus) }}
            </Badge>
          </div>
          <p class="text-xs text-muted-foreground">
            Bitiş: {{ formatDate(rentalInfo.contractEndDate) }}
          </p>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent>
          ...
          <p class="text-xs text-muted-foreground">
            Son ödeme: {{ formatDate(rentalInfo.lastPaymentDate) }}
          </p>
        </CardContent>
      </Card>
    </div>
            ...
            <div class="grid gap-4">
              ...
              <div>
                ...
                <div class="flex flex-wrap gap-2">
                  <Badge
                    v-for="amenity in rentalInfo.property.amenities"
                    :key="amenity"
                    variant="secondary"
                  >
                    {{ amenity }}
          ...
          <CardHeader>
            <div class="flex items-center justify-between">
              ...
              <Button
                variant="outline"
                class="gap-2"
                @click="navigateTo('/my-rental/payments')"
              >
                <Eye class="h-4 w-4" />
                Tümünü Gör
              </Button>
          ...
          <CardHeader>
            <div class="flex items-center justify-between">
              ...
              <Button
                variant="outline"
                class="gap-2"
                @click="navigateTo('/my-rental/maintenance')"
              >
                <Eye class="h-4 w-4" />
                Tümünü Gör
              </Button>
          ...
          <CardContent>
            <div class="space-y-3">
              ...
              >
                <div class="flex items-center gap-3">
                  <component
                    :is="getMaintenanceIcon(request.category)"
      ...
      <div class="space-y-6">
        ...
        <Card>
          ...
          <CardContent class="space-y-3">
            <Button
              class="w-full gap-2"
              @click="navigateTo('/my-rental/contract')"
            >
            ...
            <div class="space-y-3 text-sm">
              <div class="p-3 bg-blue-50 border border-blue-200 rounded-lg">
                <p class="text-blue-800">
                  <strong>Ödeme Hatırlatması:</strong> Kira ödemelerinizi her
                  ayın {{ rentalInfo.paymentDay }}. günü yapınız.
                </p>
              </div>
              <div class="p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
                <p class="text-yellow-800">
                  <strong>Sözleşme Yenileme:</strong> Sözleşmenizin bitiş
                  tarihine {{ getRemainingDays() }} gün kaldı.
                </p>
              </div>
              <div class="p-3 bg-green-50 border border-green-200 rounded-lg">
                <p class="text-green-800">
                  <strong>Bakım Talepleri:</strong> Acil olmayan bakım talepleri
                  için sistem üzerinden talepte bulunun.
                </p>
              </div>
            </div>
          </CardContent>
