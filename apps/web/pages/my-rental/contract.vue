    ...
    <div class="flex items-center justify-between mb-6">
      <div>
        ...
        <p class="text-muted-foreground">
          Kira sözleşmenizin detaylı bilgileri
        </p>
      </div>
            ...
            <div class="grid gap-4">
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  >
                  <p class="font-medium">
                    Her ayın {{ contract.paymentDay }}. günü
                  </p>
                </div>
                <div>
                  <Label class="text-sm font-medium text-muted-foreground"
                    >Kira Artış Oranı</Label
                  >
                  <p class="font-medium">
                    {{ contract.increaseRate }}% (yıllık)
                  </p>
                </div>
              </div>
            ...
            <div class="grid gap-4">
              <div class="flex items-start gap-4">
                ...
                <div class="flex-1">
                  ...
                  <div
                    class="grid grid-cols-2 md:grid-cols-4 gap-3 mt-3 text-sm"
                  >
                    <div>
                    ...
                    <div>
                      ...
                      <span class="ml-1 font-medium">{{
                        contract.property.furnished ? "Evet" : "Hayır"
                      }}</span>
                    </div>
                  </div>
                </div>
              ...
              <div>
                ...
                <div class="flex flex-wrap gap-2">
                  <Badge
                    v-for="feature in contract.property.features"
                    :key="feature"
                    variant="secondary"
                  >
                    {{ feature }}
        ...
        <Card>
          ...
          <CardContent class="space-y-3">
            ...
            <div class="flex items-center justify-between">
              ...
              <Badge variant="outline">{{
                formatDate(contract.renewalNoticeDate)
              }}</Badge>
            </div>
          </CardContent>
        </Card>
  ...
  terms: [
    {
      title: "Kira Ödemesi",
      description:
        "Kira ödemesi her ayın 1. günü yapılacaktır. 5 gün gecikme toleransı vardır.",
    },
    {
      title: "Depozito",
      description:
    ...
    },
    {
      ...
      description:
        "Küçük bakımlar kiracı, büyük onarımlar ev sahibi tarafından karşılanacaktır.",
    },
    {
      title: "Erken Çıkış",
      description:
        "Sözleşme süresinden önce çıkış için 30 gün önceden bildirim yapılmalıdır.",
    },
  ],
});
