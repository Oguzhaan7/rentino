    ...
    <Card class="overflow-hidden p-0">
      <CardContent class="grid p-0 md:grid-cols-2">
        <form class="p-6 md:p-8" @submit.prevent="handleLogin">
          <div class="flex flex-col gap-6">
            <div class="flex flex-col items-center text-center">
              ...
              <p class="text-muted-foreground text-balance">Login to your Rentino account</p>
            </div>
            ...
            <div class="grid gap-3">
              ...
              <Input id="password" v-model="form.password" type="password" required :disabled="isLoading" />
            </div>
        ...
        <div class="bg-muted relative hidden md:block">
          <div
            class="absolute inset-0 h-full w-full bg-gradient-to-br from-blue-500 via-purple-600 to-pink-500 opacity-80"
          />
          <div class="absolute inset-0 flex items-center justify-center">
            <div class="text-white text-center">
              <h2 class="text-2xl font-bold">Rentino'ya Hoş Geldiniz</h2>
              <p class="mt-2 text-lg">Gayrimenkul yönetiminizi kolaylaştırın</p>
            </div>
          </div>
        </div>
      </CardContent>
